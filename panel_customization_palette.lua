...
function CreateCommonPalette(FrameTemplate, ftCollision, classType, paramType, paramIndex, PaletteIndex, historyapply)
  clearPalette()
...
function CreateEyePalette(FrameTemplate, ftCollision, classType, paramType, paramIndex, paramIndex2, PaletteIndex, CheckControl1, CheckControl2, historyapply)
  clearPalette()
...
function setConsoleHeightPalette(height)
