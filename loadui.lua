...
function preloadCustomizationUI()
  loadUI("UI_Data/Customization/Panel_Customization_ConsoleKeyGuide.XML", "Panel_Customization_ConsoleKeyGuide", UIGroup.PAGameUIGroup_Windows, PAUIRenderModeBitSet({
    RenderMode.eRenderMode_Default,
    RenderMode.eRenderMode_IngameCustomize
  }))
...
function loadCustomizationUI()
  runLua("UI_Data/Script/Customization/Customization_Console.lua")
...
function preLoadGameUI()
  ...
  if true == _ContentsGroup_isConsoleTest then
    basicLoadUI("UI_Data/Widget/Menu/Console/Panel_QuickMenu.xml", "Panel_QuickMenu", UIGroup.PAGameUIGroup_Widget)
    basicLoadUI("UI_Data/Widget/Menu/Console/Panel_QuickMenuCustom.xml", "Panel_QuickMenuCustom", UIGroup.PAGameUIGroup_Windows)
  end
  basicLoadUI("UI_Data/Window/NpcGift/Panel_Window_NpcGift.xml", "Panel_Window_NpcGift", UIGroup.PAGameUIGroup_Windows)
end
...
function loadGameUI()
  ...
  runLua("UI_Data/Script/Window/NpcGift/Panel_Window_NpcGift.lua")
