...
function Itemmarket_CategoryUpdate(contents, key)
  ...
  if not isWakenWeaponOpen then
    _PA_LOG("\236\160\149\237\131\156\234\179\164", "\236\151\172\234\184\176 \235\147\164\236\150\180\236\152\164\235\169\180\236\149\136\235\144\169\235\139\136\235\139\164.")
  ...
  elseif not isAlchemyStoneOpen then
    _PA_LOG("\236\160\149\237\131\156\234\179\164", "\236\151\172\234\184\176 \235\147\164\236\150\180\236\152\164\235\130\152\236\154\148 ?  \236\149\188\227\133\149\227\132\180\234\184\136\236\132\157\236\157\180 \236\149\136\236\151\180\235\160\164\236\158\136\235\138\148\235\141\176!?")
    _categoryTexture = {
      [0] = {
        [0] = {
          204,
    ...
    _PA_LOG("\236\160\149\237\131\156\234\179\164", "\236\151\172\234\184\176 \235\147\164\236\150\180\236\152\164\235\130\152\236\154\148 ?  \236\151\176\234\184\136\236\132\157\236\157\180 \236\151\180\235\160\164\236\158\136\235\138\148\235\141\176 \236\163\188\236\157\152\237\149\152\236\139\156\236\163\160@!")
    _categoryTexture = {
      [0] = {
        [0] = {
          204,
...
function Itemmarket_ListUpdate(contents, key)
  ...
  if true == self.isGrouplist then
    ...
    if nil ~= itemMarketSummaryInfo then
      ...
      itemList_AttentionItem:addInputEvent("Mouse_LUp", "HandleClicked_ItemMarket_SetAlarm( " .. itemEnchantKeyRaw .. " )")
      itemList_AttentionItem:addInputEvent("Mouse_On", "_itemMarket_ShowListOutSideTooltip( true, 6, " .. idx .. " )")
      itemList_AttentionItem:addInputEvent("Mouse_Out", "_itemMarket_ShowListOutSideTooltip( false )")
      itemList_ReservationItem:addInputEvent("Mouse_LUp", "FGlobal_ItemMarketPreBid_Open( " .. itemEnchantKeyRaw .. ", 0)")
      itemList_ReservationItem:addInputEvent("Mouse_On", "_itemMarket_ShowListOutSideTooltip( true, 7, " .. idx .. " )")
      itemList_ReservationItem:addInputEvent("Mouse_Out", "_itemMarket_ShowListOutSideTooltip( false )")
      ...
      if 0 == Int64toInt32(itemMarketSummaryInfo:getDisplayedTotalAmount()) then
        ...
        itemList_AttentionItem:SetShow(true)
        itemList_ReservationItem:SetShow(not self.isWorldMapOpen and isPreBidOpen and isGameServiceTypeDev())
